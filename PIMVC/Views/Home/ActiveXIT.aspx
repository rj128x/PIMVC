...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<script type="text/javascript">
		$(document).ready(function () {
		    pi.createObjectDisplay('<%=AppHelper.getPDIPath(Request,"ИТ Монитор.pdi") %>');
		});
	</script>
	<div class="ui-tabs ui-widget ui-widget-content ui-corner-all fullScreen">
		<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">			
			<li class="ui-state-default ui-corner-top">
			<a class='displayOpen' url='<%=AppHelper.getPDIPath(Request,"ИТ Монитор.pdi") %>'
				href="#">ИТ Монитор</a></li>			
		</ul>
		<div align="center">		
