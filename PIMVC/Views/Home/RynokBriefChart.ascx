...
<object data="data:application/x-silverlight," type="application/x-silverlight-2"
	...
	<param name="initParams" value="propFileName=<%=Server.MapPath("/Data/Charts/")%>RynokBrief.xml,mode=visiblox,target=rynokChart,dateStart=<%=Model.Request.DateTimeStart%>,dateEnd=<%=Model.Request.DateTimeEnd%>,interval=1m,recorded=true" />
